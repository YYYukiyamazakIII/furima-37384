...
ActiveRecord::Schema.define(version: 2022_04_23_123436) do
  ...
  create_table "good_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "item_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_good_items_on_item_id"
    t.index ["user_id"], name: "index_good_items_on_user_id"
  end
  ...
  add_foreign_key "good_items", "items"
  add_foreign_key "good_items", "users"
